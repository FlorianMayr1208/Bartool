...
1. Create `backend/app/main.py` with the production API entrypoint and shared middleware.  
...
4. Add an API client that calls the inventory, recipes, barcode, and synonyms endpoints used by the product UI.
